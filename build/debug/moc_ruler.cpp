...
#include <memory>
#include "../../graphics_lib/inc/ruler.h"
...
QT_MOC_LITERAL(1, 6, 15), // "rightMouseClick"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Ruler\0rightMouseClick\0"
};
...
void Ruler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Ruler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ruler::rightMouseClick)) {
                *result = 0;
                return;
            }
        }
