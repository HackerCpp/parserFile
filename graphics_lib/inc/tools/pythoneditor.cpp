...
PythonEditor::PythonEditor()
{
    ...
    textEdit = new QsciScintilla;
        ...
        setCurrentFile("");
        QsciLexerPython * lexPython = new QsciLexerPython(this); // создаем лексер (схему подсветки)
        lexPython->setColor(QColor(Qt::green), QsciLexerPython::Comment);
        //lexPython->setPaper(QColor("darkblue"), QsciLexerPython::Comment);
        //lexPython->setFont(QFont('DejaVu Sans'), QsciLexerPython.Comment);
        textEdit->setLexer(lexPython); // задаем С++ лексер нашему редактору
}
