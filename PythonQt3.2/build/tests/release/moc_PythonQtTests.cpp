...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestApi_t, stringdata0) + ofs \
...
void PythonQtTestApi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestApi *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
void *PythonQtTestApi::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestApi.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassD_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassD.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "ClassA"))
        return static_cast< ClassA*>(this);
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassAWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClassAWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { ClassA* _r = _t->new_ClassA();
            if (_a[0]) *reinterpret_cast< ClassA**>(_a[0]) = std::move(_r); }  break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassAWrapper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassBWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClassBWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { ClassB* _r = _t->new_ClassB();
            if (_a[0]) *reinterpret_cast< ClassB**>(_a[0]) = std::move(_r); }  break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassBWrapper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassCWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClassCWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { ClassC* _r = _t->new_ClassC();
            if (_a[0]) *reinterpret_cast< ClassC**>(_a[0]) = std::move(_r); }  break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassCWrapper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassDWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClassDWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { ClassD* _r = _t->new_ClassD();
            if (_a[0]) *reinterpret_cast< ClassD**>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
}
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ClassDWrapper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestApiHelper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestApiHelper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestApiHelper.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "PythonQtImportFileInterface"))
        return static_cast< PythonQtImportFileInterface*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PQCppObjectWrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PQCppObjectWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PQCppObjectWrapper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PQCppObjectDecorator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PQCppObjectDecorator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PQCppObjectDecorator.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PQCppObjectNoWrapDecorator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PQCppObjectNoWrapDecorator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { PQCppObjectNoWrap* _r = _t->new_PQCppObjectNoWrap();
            if (_a[0]) *reinterpret_cast< PQCppObjectNoWrap**>(_a[0]) = std::move(_r); }  break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PQCppObjectNoWrapDecorator.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PQCppObject2Decorator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PQCppObject2Decorator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { PQCppObject2* _r = _t->new_PQCppObject2();
            if (_a[0]) *reinterpret_cast< PQCppObject2**>(_a[0]) = std::move(_r); }  break;
        case 1: { TestEnumFlag _r = _t->testEnumFlag1((*reinterpret_cast< PQCppObject2*(*)>(_a[1])),(*reinterpret_cast< TestEnumFlag(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< TestEnumFlag*>(_a[0]) = std::move(_r); }  break;
        case 2: { PQCppObject2::TestEnumFlag _r = _t->testEnumFlag2((*reinterpret_cast< PQCppObject2*(*)>(_a[1])),(*reinterpret_cast< PQCppObject2::TestEnumFlag(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< PQCppObject2::TestEnumFlag*>(_a[0]) = std::move(_r); }  break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PQCppObject2Decorator.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestSlotCalling_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestSlotCalling *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->initTestCase(); break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestSlotCalling.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
struct qt_meta_stringdata_PythonQtTestSlotCallingHelper_t {
    ...
    char stringdata0[1846];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestSlotCallingHelper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestSlotCallingHelper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setPassed(); break;
        ...
        case 27: { QList<uint> _r = _t->getQListUnsignedInt();
            if (_a[0]) *reinterpret_cast< QList<uint>*>(_a[0]) = std::move(_r); }  break;
        ...
        case 31: { QList<quint64> _r = _t->getQListquint64();
            if (_a[0]) *reinterpret_cast< QList<quint64>*>(_a[0]) = std::move(_r); }  break;
        ...
        case 38: { QVector<QPair<double,QColor> > _r = _t->getQVectorQPair1((*reinterpret_cast< const QVector<QPair<double,QColor> >(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVector<QPair<double,QColor> >*>(_a[0]) = std::move(_r); }  break;
        ...
        case 40: { QPair<double,QColor> _r = _t->getQPair((*reinterpret_cast< const QPair<double,QColor>(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QPair<double,QColor>*>(_a[0]) = std::move(_r); }  break;
        case 41: { QPair<double,QVariant> _r = _t->getQPairVariant((*reinterpret_cast< const QPair<double,QVariant>(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QPair<double,QVariant>*>(_a[0]) = std::move(_r); }  break;
        ...
        case 50: { PythonQtTestSlotCallingHelper* _r = _t->getTestObject((*reinterpret_cast< PythonQtTestSlotCallingHelper*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< PythonQtTestSlotCallingHelper**>(_a[0]) = std::move(_r); }  break;
        ...
        case 55: { PQCppObject* _r = _t->createPQCppObject((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< PQCppObject**>(_a[0]) = std::move(_r); }  break;
        ...
        case 60: { PQUnknownButRegisteredValueObject _r = _t->getUnknownButRegisteredValueObjectAsValue();
            if (_a[0]) *reinterpret_cast< PQUnknownButRegisteredValueObject*>(_a[0]) = std::move(_r); }  break;
        case 61: { PQUnknownValueObject _r = _t->getUnknownValueObjectAsValue();
            if (_a[0]) *reinterpret_cast< PQUnknownValueObject*>(_a[0]) = std::move(_r); }  break;
        ...
        case 1: *reinterpret_cast< float*>(_v) = _t->floatProp(); break;
        case 2: *reinterpret_cast< QVariantList*>(_v) = _t->variantListProp(); break;
        case 3: *reinterpret_cast< QVariantMap*>(_v) = _t->variantMapProp(); break;
        case 4: *reinterpret_cast< QVariant*>(_v) = _t->variantProp(); break;
        case 5: *reinterpret_cast< QObject**>(_v) = _t->qObjectProp(); break;
        case 6: *reinterpret_cast< QList<QObject*>*>(_v) = _t->qObjectListProp(); break;
        case 7: *reinterpret_cast< QSize*>(_v) = _t->sizeProp(); break;
        default: break;
        }
        ...
        case 1: _t->setFloatProp(*reinterpret_cast< float*>(_v)); break;
        case 2: _t->setVariantListProp(*reinterpret_cast< QVariantList*>(_v)); break;
        case 3: _t->setVariantMapProp(*reinterpret_cast< QVariantMap*>(_v)); break;
        case 4: _t->setVariantProp(*reinterpret_cast< QVariant*>(_v)); break;
        case 5: _t->setQObjectProp(*reinterpret_cast< QObject**>(_v)); break;
        case 6: _t->setQObjectListProp(*reinterpret_cast< QList<QObject*>*>(_v)); break;
        case 7: _t->setSizeProp(*reinterpret_cast< QSize*>(_v)); break;
        default: break;
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestSlotCallingHelper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestSignalHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestSignalHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->initTestCase(); break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestSignalHandler.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtTestSignalHandlerHelper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PythonQtTestSignalHandlerHelper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::intSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::floatSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::variantSignal)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(int , float , const QStringList & , QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::complexSignal)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(PQCppObject2::TestEnumFlag );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::enumSignal)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::signal1)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::signal2)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (PythonQtTestSignalHandlerHelper::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQtTestSignalHandlerHelper::signal3)) {
                *result = 7;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtTestSignalHandlerHelper.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
