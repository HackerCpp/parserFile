...
void SpectrReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SpectrReader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SpectrReader::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseCurveReader::staticMetaObject>(),
    qt_meta_stringdata_SpectrReader.data,
    qt_meta_data_SpectrReader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
