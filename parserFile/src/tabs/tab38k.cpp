...
<tr><td>reserve </td><td> %2</td></tr>\
<tr><td>reserve2 </td><td> %3</td></tr>\
<tr><td>CRC16 </td><td> %4</td></tr>";
    str = str.arg(pF->total_length).arg(pF->reserve).arg(pF->reserve1).arg(pF->crc16);
    return str;
}
