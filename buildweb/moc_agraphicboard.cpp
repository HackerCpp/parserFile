...
void AGraphicBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AGraphicBoard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AGraphicBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_AGraphicBoard.data,
    qt_meta_data_AGraphicBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AGraphicBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "BoardForTrack"))
        return static_cast< BoardForTrack*>(this);
