...
QT_MOC_LITERAL(4, 53, 13), // "scrollChanged"
QT_MOC_LITERAL(5, 67, 14) // "timerLeftClick"

    },
    "VerticalBoard\0changingTheVisibilityZone\0"
    "\0visibleArea\0scrollChanged\0timerLeftClick"
};
...
void VerticalBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VerticalBoard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changingTheVisibilityZone((*reinterpret_cast< QRectF(*)>(_a[1]))); break;
        case 1: _t->scrollChanged(); break;
        case 2: _t->timerLeftClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VerticalBoard::*)(QRectF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VerticalBoard::changingTheVisibilityZone)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VerticalBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<AGraphicBoard::staticMetaObject>(),
    qt_meta_stringdata_VerticalBoard.data,
    qt_meta_data_VerticalBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
