...
#include "../../graphics_lib/inc/tools/qxtspanslider.h"
...
QT_MOC_LITERAL(9, 117, 13), // "sliderPressed"
QT_MOC_LITERAL(10, 131, 10), // "SpanHandle"
QT_MOC_LITERAL(11, 142, 6), // "handle"
QT_MOC_LITERAL(12, 149, 13), // "setLowerValue"
QT_MOC_LITERAL(13, 163, 13), // "setUpperValue"
QT_MOC_LITERAL(14, 177, 7), // "setSpan"
QT_MOC_LITERAL(15, 185, 16), // "setLowerPosition"
QT_MOC_LITERAL(16, 202, 16), // "setUpperPosition"
QT_MOC_LITERAL(17, 219, 10), // "lowerValue"
QT_MOC_LITERAL(18, 230, 10), // "upperValue"
QT_MOC_LITERAL(19, 241, 13), // "lowerPosition"
QT_MOC_LITERAL(20, 255, 13), // "upperPosition"
QT_MOC_LITERAL(21, 269, 18), // "handleMovementMode"
QT_MOC_LITERAL(22, 288, 18), // "HandleMovementMode"
QT_MOC_LITERAL(23, 307, 12), // "FreeMovement"
QT_MOC_LITERAL(24, 320, 10), // "NoCrossing"
QT_MOC_LITERAL(25, 331, 13) // "NoOverlapping"
    ...
    "sliderPressed\0SpanHandle\0handle\0"
...
void QxtSpanSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QxtSpanSlider::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::spanChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QxtSpanSlider::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::lowerValueChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QxtSpanSlider::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::upperValueChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QxtSpanSlider::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::lowerPositionChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QxtSpanSlider::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::upperPositionChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QxtSpanSlider::*_t)(SpanHandle );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtSpanSlider::sliderPressed)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QxtSpanSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_QxtSpanSlider.data,
      qt_meta_data_QxtSpanSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
