/****************************************************************************
** Meta object code from reading C++ file 'customdelegates.h'
**
...
#include "../../graphics_lib/inc/tools/customdelegates.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'customdelegates.h' doesn't include <QObject>."
...
const QMetaObject CheckBoxDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_CheckBoxDelegate.data,
      qt_meta_data_CheckBoxDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
struct qt_meta_stringdata_ColorDelegate_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ColorDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ColorDelegate_t qt_meta_stringdata_ColorDelegate = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ColorDelegate"
...
void ColorDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject ColorDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_ColorDelegate.data,
      qt_meta_data_ColorDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ColorDelegate.stringdata0))
...
const QMetaObject ComboBoxDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_ComboBoxDelegate.data,
