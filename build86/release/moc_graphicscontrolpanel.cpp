...
void GraphicsControlPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GraphicsControlPanel *_t = static_cast<GraphicsControlPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GraphicsControlPanel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedDrawType)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)(DrawSettings::FormatTime );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedFormatTime)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)(DrawSettings::FormatDepth );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedFormatDepth)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)(DrawSettings::LengthPicture );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedPictureHeight)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)(QImage::Format );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedPictureFormat)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::changedScalePixelPerMm)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (GraphicsControlPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsControlPanel::refresh)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject GraphicsControlPanel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GraphicsControlPanel.data,
      qt_meta_data_GraphicsControlPanel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GraphicsControlPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GraphicsControlPanel.stringdata0))
        return static_cast<void*>(const_cast< GraphicsControlPanel*>(this));
