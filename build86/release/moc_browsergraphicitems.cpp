...
void BrowserGraphicItems::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BrowserGraphicItems *_t = static_cast<BrowserGraphicItems *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject BrowserGraphicItems::staticMetaObject = {
    { &BaseSettingsWindow::staticMetaObject, qt_meta_stringdata_BrowserGraphicItems.data,
      qt_meta_data_BrowserGraphicItems,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BrowserGraphicItems::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BrowserGraphicItems.stringdata0))
        return static_cast<void*>(const_cast< BrowserGraphicItems*>(this));
