...
const QMetaObject DataTreeView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_DataTreeView.data,
      qt_meta_data_DataTreeView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
