...
void WidgetSelectWaveSegment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WidgetSelectWaveSegment *_t = static_cast<WidgetSelectWaveSegment *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject WidgetSelectWaveSegment::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WidgetSelectWaveSegment.data,
      qt_meta_data_WidgetSelectWaveSegment,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WidgetSelectWaveSegment::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WidgetSelectWaveSegment.stringdata0))
        return static_cast<void*>(const_cast< WidgetSelectWaveSegment*>(this));
