...
void ModelMulticolor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ModelMulticolor *_t = static_cast<ModelMulticolor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ModelMulticolor::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_ModelMulticolor.data,
      qt_meta_data_ModelMulticolor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ModelMulticolor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModelMulticolor.stringdata0))
        return static_cast<void*>(const_cast< ModelMulticolor*>(this));
