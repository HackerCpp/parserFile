...
void SettingsItems::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsItems *_t = static_cast<SettingsItems *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SettingsItems::staticMetaObject = {
    { &BaseSettingsWindow::staticMetaObject, qt_meta_stringdata_SettingsItems.data,
      qt_meta_data_SettingsItems,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SettingsItems::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SettingsItems.stringdata0))
        return static_cast<void*>(const_cast< SettingsItems*>(this));
...
const QMetaObject Selection::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_Selection.data,
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsLineItem *_t = static_cast<SettingsLineItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SettingsLineItem::staticMetaObject = {
    { &SettingsItem::staticMetaObject, qt_meta_stringdata_SettingsLineItem.data,
      qt_meta_data_SettingsLineItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SettingsLineItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SettingsLineItem.stringdata0))
        return static_cast<void*>(const_cast< SettingsLineItem*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsSpectrItem *_t = static_cast<SettingsSpectrItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SettingsSpectrItem::staticMetaObject = {
    { &SettingsItem::staticMetaObject, qt_meta_stringdata_SettingsSpectrItem.data,
      qt_meta_data_SettingsSpectrItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SettingsSpectrItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SettingsSpectrItem.stringdata0))
        return static_cast<void*>(const_cast< SettingsSpectrItem*>(this));
    return SettingsItem::qt_metacast(_clname);
}
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsAcuItem *_t = static_cast<SettingsAcuItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configure(); break;
        default: ;
...
const QMetaObject SettingsAcuItem::staticMetaObject = {
    { &SettingsItem::staticMetaObject, qt_meta_stringdata_SettingsAcuItem.data,
      qt_meta_data_SettingsAcuItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SettingsAcuItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SettingsAcuItem.stringdata0))
        return static_cast<void*>(const_cast< SettingsAcuItem*>(this));
    return SettingsItem::qt_metacast(_clname);
}
