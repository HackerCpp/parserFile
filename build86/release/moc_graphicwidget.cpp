...
void GraphicWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GraphicWidget *_t = static_cast<GraphicWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject GraphicWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GraphicWidget.data,
      qt_meta_data_GraphicWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
